...
This document provides comprehensive data flow specifications for the Bot Core cryptocurrency trading platform. It details how data flows through the system from external sources (Binance WebSocket), through internal processing (Rust Core Engine), to the frontend dashboard, and back to external services for trade execution.
