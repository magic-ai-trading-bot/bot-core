...
**Port:** 8080
**Total Endpoints:** 75+ (documented: 37 core endpoints; actual codebase has ~75+ including real trading, settings, notifications, and auth security endpoints not yet fully documented here)
...
**Total Documented Endpoints:** 37 (core endpoints only; actual total ~75+ with real trading, settings, notifications, and additional auth endpoints)
