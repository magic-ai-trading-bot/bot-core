...
# === MCP SERVER & OPENCLAW ===
MCP_AUTH_TOKEN=GENERATE_64_CHAR_HEX_TOKEN
OPENCLAW_GATEWAY_TOKEN=GENERATE_SECURE_GATEWAY_TOKEN
BOTCORE_EMAIL=admin@botcore.local
BOTCORE_PASSWORD=STRONG_ADMIN_PASSWORD
...
# Claude AI session keys (from Claude.ai browser session)
CLAUDE_AI_SESSION_KEY=your_claude_ai_session_key
CLAUDE_WEB_SESSION_KEY=your_claude_web_session_key
```
