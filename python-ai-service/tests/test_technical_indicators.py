...
class TestCalculateRSI:
    ...
    def test_calculate_rsi_exception_handling(self, mock_rsi, tech_indicators, sample_df):
...
class TestCalculateMACD:
    ...
    def test_calculate_macd_exception_handling(self, mock_macd, tech_indicators, sample_df):
...
class TestCalculateEMA:
    ...
    def test_calculate_ema_exception_handling(self, mock_ema, tech_indicators, sample_df):
...
class TestCalculateBollingerBands:
    ...
    def test_calculate_bollinger_bands_default(self, tech_indicators, sample_df):
        ...
        assert all(key in bb for key in ['bb_upper', 'bb_middle', 'bb_lower', 'bb_width', 'bb_percent'])
    ...
    def test_calculate_bollinger_bands_custom_params(self, tech_indicators, sample_df):
        ...
        bb = tech_indicators.calculate_bollinger_bands(sample_df, period=30, std_dev=2.5)
        assert isinstance(bb, dict)
        assert len(bb) == 5
    ...
    def test_calculate_bollinger_bands_exception_handling(self, mock_bb, tech_indicators, sample_df):
...
class TestCalculateVolumeIndicators:
    ...
    def test_calculate_volume_indicators_custom_period(self, tech_indicators, sample_df):
        """Test volume indicators with custom period"""
        vol_indicators = tech_indicators.calculate_volume_indicators(sample_df, period=30)
        assert isinstance(vol_indicators, dict)
    ...
    def test_calculate_volume_indicators_exception_handling(self, tech_indicators, sample_df):
...
class TestCalculateStochastic:
    ...
    def test_calculate_stochastic_exception_handling(self, mock_stoch, tech_indicators, sample_df):
...
class TestCalculateATR:
    ...
    def test_calculate_atr_exception_handling(self, mock_atr, tech_indicators, sample_df):
...
class TestCalculateMomentumIndicators:
    ...
    def test_calculate_momentum_indicators_exception_handling(self, mock_roc, tech_indicators, sample_df):
...
class TestCalculateAllIndicators:
    ...
    def test_calculate_all_indicators(self, tech_indicators, sample_df):
        ...
        assert all(col in enriched_df.columns for col in ['open', 'high', 'low', 'close', 'volume'])

        # Check that main indicator columns are added (some may fail due to API issues)
        main_indicator_columns = ['rsi', 'macd', 'macd_signal', 'macd_histogram',
                           'ema_9', 'ema_21', 'ema_50',
    ...
    def test_calculate_all_indicators_pattern_columns(self, tech_indicators, sample_df):
        ...
        pattern_columns = ['local_high', 'local_low', 'breakout_high',
                          'breakout_low', 'doji', 'hammer']
    ...
    def test_calculate_all_indicators_pattern_conversion(self, tech_indicators, sample_df):
    ...
    def test_calculate_all_indicators_momentum_integration(self, tech_indicators, sample_df):
    ...
    def test_calculate_all_indicators_pattern_error_handling(self, mock_patterns, tech_indicators, sample_df):
    ...
    @patch('features.technical_indicators.TechnicalIndicators.calculate_momentum_indicators')
    def test_calculate_all_indicators_momentum_error_handling(self, mock_momentum, tech_indicators, sample_df):
