...
def sample_klines():
    ...
    return [
        [1701234567000, "45000", "45500", "44800", "45200", "1000", 1701238167000, 
         "45000000", 100, "500", "22500000", "0"],
        [1701238167000, "45200", "45600", "45000", "45400", "1200", 1701241767000,
         "54240000", 120, "600", "27120000", "0"],
        [1701241767000, "45400", "45800", "45200", "45600", "1100", 1701245367000,
         "50160000", 110, "550", "25080000", "0"],
        [1701245367000, "45600", "46000", "45400", "45800", "1300", 1701248967000,
         "59540000", 130, "650", "29770000", "0"],
        [1701248967000, "45800", "46200", "45600", "46000", "1400", 1701252567000,
         "64400000", 140, "700", "32200000", "0"]
    ]
...
class TestTechnicalAnalyzer:
    ...
    def test_calculate_indicators(self, technical_analyzer, sample_klines):
        ...
        required_indicators = [
            ...
            'ema_9', 'ema_21', 'ema_50', 'volume_sma', 'atr',
            'adx', 'stochastic_k', 'stochastic_d'
        ]
...
class TestEdgeCases:
    ...
    def test_single_candle(self, technical_analyzer):
        ...
        klines = [[1701234567000, "45000", "45500", "44800", "45200", "1000", 
                   1701238167000, "45000000", 100, "500", "22500000", "0"]]
    ...
    def test_extreme_values(self, technical_analyzer):
        ...
        klines = [
            [1701234567000, "1", "1000000", "0.0001", "500000", "999999999", 
             1701238167000, "45000000", 100, "500", "22500000", "0"],
            [1701238167000, "500000", "1000000", "1", "999999", "999999999",
             1701241767000, "54240000", 120, "600", "27120000", "0"]
        ]
