  ...
  return (
    <GlassCard className="p-6 h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <button onClick={() => navigate('/trade-history')} className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-white/5 transition-all flex-shrink-0 self-start sm:self-auto" style={{ color: colors.textMuted }}>
          {t('trades.viewAll')}
