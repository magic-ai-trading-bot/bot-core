...
const AISignals = () => {
  ...
  // Request NEW signals for all symbols (called when user clicks refresh button)
  // @spec:FR-AI-014 - Manual Signal Refresh
  // Signals are generated by the Rust strategy engine and fetched via cached signals endpoint
  const requestNewSignals = async () => {
    try {
      // Fetch updated cached signals from database (generated by Rust strategy engine)
