  ...
  const syncFromPaper = useCallback(async (): Promise<SyncPreview | null> => {
    try {
      ...
      const fieldMap: Array<{
        ...
        { label: "Min Signal Confidence", realKey: "min_signal_confidence", paperPath: ["strategy", "min_ai_confidence"] },
        // Trailing stop
        { label: "Enable Trailing Stop", realKey: "enable_trailing_stop", paperPath: ["risk", "trailing_stop_enabled"] },
        { label: "Trailing Stop Activation %", realKey: "trailing_stop_activation_percent", paperPath: ["risk", "trailing_activation_pct"] },
        { label: "Trailing Stop %", realKey: "trailing_stop_percent", paperPath: ["risk", "trailing_stop_pct"] },
        // ATR-Based Sizing (backend returns these under "atr_sizing" section)
        { label: "ATR Stop Enabled", realKey: "atr_stop_enabled", paperPath: ["atr_sizing", "atr_stop_enabled"] },
        { label: "ATR Period", realKey: "atr_period", paperPath: ["atr_sizing", "atr_period"] },
        { label: "ATR Stop Multiplier", realKey: "atr_stop_multiplier", paperPath: ["atr_sizing", "atr_stop_multiplier"] },
        { label: "ATR TP Multiplier", realKey: "atr_tp_multiplier", paperPath: ["atr_sizing", "atr_tp_multiplier"] },
        { label: "Base Risk %", realKey: "base_risk_pct", paperPath: ["atr_sizing", "base_risk_pct"] },
        // Kelly Criterion
        { label: "Kelly Enabled", realKey: "kelly_enabled", paperPath: ["atr_sizing", "kelly_enabled"] },
        { label: "Kelly Min Trades", realKey: "kelly_min_trades", paperPath: ["atr_sizing", "kelly_min_trades"] },
        { label: "Kelly Fraction", realKey: "kelly_fraction", paperPath: ["atr_sizing", "kelly_fraction"] },
        { label: "Kelly Lookback", realKey: "kelly_lookback", paperPath: ["atr_sizing", "kelly_lookback"] },
        // Regime Filters
        { label: "Funding Spike Filter", realKey: "funding_spike_filter_enabled", paperPath: ["atr_sizing", "funding_spike_filter_enabled"] },
        { label: "Funding Spike Threshold", realKey: "funding_spike_threshold", paperPath: ["atr_sizing", "funding_spike_threshold"] },
        { label: "Funding Spike Reduction", realKey: "funding_spike_reduction", paperPath: ["atr_sizing", "funding_spike_reduction"] },
        { label: "ATR Spike Filter", realKey: "atr_spike_filter_enabled", paperPath: ["atr_sizing", "atr_spike_filter_enabled"] },
        { label: "ATR Spike Multiplier", realKey: "atr_spike_multiplier", paperPath: ["atr_sizing", "atr_spike_multiplier"] },
        { label: "ATR Spike Reduction", realKey: "atr_spike_reduction", paperPath: ["atr_sizing", "atr_spike_reduction"] },
        { label: "Consec. Loss Reduction", realKey: "consecutive_loss_reduction_enabled", paperPath: ["atr_sizing", "consecutive_loss_reduction_enabled"] },
        { label: "Consec. Loss Reduction %", realKey: "consecutive_loss_reduction_pct", paperPath: ["atr_sizing", "consecutive_loss_reduction_pct"] },
        { label: "Consec. Loss Threshold", realKey: "consecutive_loss_reduction_threshold", paperPath: ["atr_sizing", "consecutive_loss_reduction_threshold"] },
        // Signal Reversal
