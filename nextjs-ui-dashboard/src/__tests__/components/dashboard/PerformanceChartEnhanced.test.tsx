  ...
  describe('Chart Data Generation from Real Trades', () => {
      ...
      const mockClosedTrades = [
        {
          ...
          exit_price: 45500,
          pnl: 50,
          entry_time: twoDaysAgo.toISOString(),
          exit_time: twoDaysAgo.toISOString(),
        ...
        },
        {
          ...
          exit_price: 2950,
          pnl: 50,
          entry_time: oneDayAgo.toISOString(),
          exit_time: oneDayAgo.toISOString(),
    ...
    it('builds cumulative P&L from trade history', () => {
      ...
      const trades = Array.from({ length: 10 }, (_, i) => ({
        ...
        entry_time: new Date(now.getTime() - (10 - i) * 24 * 60 * 60 * 1000).toISOString(),
        exit_time: new Date(now.getTime() - (10 - i) * 24 * 60 * 60 * 1000).toISOString(),
      ...
      const trades = [
        {
          ...
          exit_price: 45500,
          pnl: 100,
          entry_time: new Date(now.getTime() - 48 * 60 * 60 * 1000).toISOString(),
          exit_time: new Date(now.getTime() - 48 * 60 * 60 * 1000).toISOString(),
        ...
        },
        {
          ...
          exit_price: 2950,
          pnl: 50,
          entry_time: new Date(now.getTime() - 24 * 60 * 60 * 1000).toISOString(),
          exit_time: new Date(now.getTime() - 24 * 60 * 60 * 1000).toISOString(),
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('handles very large number of trades efficiently', () => {
      ...
      const largeTrades = Array.from({ length: 1000 }, (_, i) => ({
        ...
        exit_price: 45500,
        pnl: 10,
        entry_time: new Date(now.getTime() - (1000 - i) * 60 * 60 * 1000).toISOString(),
        exit_time: new Date(now.getTime() - (1000 - i) * 60 * 60 * 1000).toISOString(),
