    ...
    const closedTrades = [
      {
        ...
        exit_price: 51000,
        pnl: 100,
        open_time: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    const closedTrades = [
      {
        ...
        exit_price: 51000,
        pnl: 100,
        open_time: new Date(now - 2 * 24 * 60 * 60 * 1000).toISOString(),
      ...
      },
      {
        ...
        exit_price: 3100,
        pnl: 50,
        open_time: new Date(now - 2 * 24 * 60 * 60 * 1000 + 3600000).toISOString(),
  ...
  it('handles equity progression correctly', async () => {
    const closedTrades = [
      ...
      },
      {
        ...
        exit_price: 3050,
        pnl: 200,
        open_time: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(),
