...
print('🌱 Starting MongoDB seed data...\n');

// IMPORTANT: Rust uses 'trading_bot' database, Python uses 'bot_core'
// We seed BOTH databases for compatibility
...
// ============================================================
// 1. SEED RUST DATABASE (trading_bot) - For Authentication
// ============================================================
print('📝 Creating users in trading_bot database (Rust)...');
...
const rustUserResult = db.users.insertMany(rustUsers);
print(`✅ Created ${Object.keys(rustUserResult.insertedIds).length} users in trading_bot\n`);

// ============================================================
// 2. SEED PYTHON DATABASE (bot_core) - For AI Analysis
// ============================================================
print('📝 Creating sample data in bot_core database (Python)...');
db = db.getSiblingDB('bot_core');

// 2. Create Paper Trading Accounts
print('💰 Creating paper trading accounts...');
const paperAccounts = [
    {
...
print(`✅ Created ${accountResult.insertedIds.length} paper trading accounts\n`);
...
print(`✅ Created ${positionResult.insertedIds.length} open positions\n`);

// 4. Create Sample Trades (Historical)
print('📈 Creating sample trade history...');
const trades = [
    {
        user_email: 'admin@botcore.com',
        symbol: 'BTCUSDT',
...
print(`✅ Created ${tradeResult.insertedIds.length} historical trades\n`);

// 5. Create Strategy Configurations
print('⚙️ Creating strategy configurations...');
const strategies = [
    {
...
print(`✅ Created ${strategyResult.insertedIds.length} strategy configurations\n`);
...
print(`✅ Created ${metricsResult.insertedIds.length} performance metrics\n`);
...
print(`✅ Created ${notificationResult.insertedIds.length} notifications\n`);
...
print('✅ You can now connect MongoDB Compass and view the data!\n');
